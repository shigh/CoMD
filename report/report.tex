...
on a single processor with *settings* using the default Cray compiler
and gcc. This was then compared with the performance models
...
of our performance models. The baseline run with gcc gave excellent
